	...
	<div class="<?php echo esc_attr( $container_class ); ?>" data-pages="<?php echo (int) $number_of_pages; ?>">
		...
		<?php while ( have_posts() ) : ?>
			...
			if ( 'masonry' === $blog_layout ) {
				...
				$element_orientation_class = Avada()->get_images_obj()->get_element_orientation_class( get_post_thumbnail_id() );
				$element_base_padding      = Avada()->get_images_obj()->get_element_base_padding( $element_orientation_class );
