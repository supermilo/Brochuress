    ...
    var _animateElement = function _animateElement(element, direction) {
        ...
        if( $element.data('parallax-scale') ) {
            ...
            TweenMax.set(element, {
                scale: MathUtils.map( p_el_offset.top - scrollPosition, winsize.height, -1 * $parent.outerHeight(), 1, $element.data('parallax-scale') )
            });
            ...
            TweenMax.set(element, {
                x: transformX,
                y: transformY,
                scale: MathUtils.map( p_el_offset.top - scrollPosition, winsize.height, -1 * $parent.outerHeight(), 1, $element.data('parallax-scale-move') )
            });
...
(function($){
    ...
    $(document).ready(function(){
        ...
        var $header = $("#header-section"),
            $logo   = $(".site-logo:not(.ut-overlay-site-logo)"),
        ...
        /* LightGallery
		================================================== */
        if ( $().lightGallery && site_settings !== "undefined" && site_settings.lg_type === 'lightgallery' ) {
        ...
        class UT_Animated_Cursor {
            ...
            initEvents() {
                ...
                var that = this;
                var $a = $('a, button, input[type="submit"], [data-custom-cursor]');
                ...
                this.mouseenterFn = function( event ) {
                    ...
                    if( $(this).hasClass('ut-deactivated-link') ) {
                        ...
                        if ($(event.target).data('custom-cursor')) {
                            ...
                            if( $(event.target).is('img') || $('img', event.target ).length ) {
                ...
                $(document).on('mouseenter', '.ut-morph-box-close' , function(){

                    that.DOM.el.setAttribute('data-cursor', 'link');

                }).on('mouseleave', '.ut-morph-box-close', function(){
        ...
        if( $('#ut-hover-cursor').length ) {

            new UT_Animated_Cursor( document.getElementById("ut-hover-cursor") );
