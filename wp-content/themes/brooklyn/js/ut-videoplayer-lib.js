;(function($){
	...
	$(document).ready(function(){
        ...
        var UT_Video_Actions = {
            ...
            playVideo: function( target ) {
                ...
                if( this.manuallyPaused( target ) || !this.getPlayerObject(target) ) {
                   return;
                }
        ...
        $(".ut-video-section-player-youtube").each( function(){
            ...
            if( $this.data("controlsPlayEvent") === 'play_lightbox' ) {
                ...
                $video_play_control.lightGallery({
                    selector: "this",
        ...
        $(window).load(function() {
            ...
            $(".ut-video-section-player-vimeo").each( function(){
        ...
        if( $(".ut-selfhosted-glitch-video").exists() ) {
            ...
            $('.ut-selfhosted-glitch-video').each( function(){
                ...
                if( $container.data('playEvent') === 'on_appear' ) {
                    ...
                    $container.closest('.ut-has-background-video').addClass('ut-appear-selfvideo-player').data( {'for' : $container.data('id'), 'appear-top-offset' : 'full'} ).appear();
    ...
    $(window).load(ut_force_video_height).utresize(ut_force_video_height);
