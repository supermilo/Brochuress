...
if ( ! function_exists( 'ot_type_colorpicker' ) ) {
    ...
    function ot_type_colorpicker( $args = array() ) {
        ...
        echo '<div class="ut-minicolors-wrap">';
            ...
            echo '<input data-position="' . esc_attr( $field_position ) . '" data-mode="' . esc_attr( $field_mode ) . '" type="text" name="' . esc_attr( $field_name ) . '" id="' . esc_attr( $field_id ) . '" value="' . esc_attr( $field_value ) . '" class="ut-ui-form-input ut-minicolors minicolors-input ut-color-mode-' . esc_attr( $field_mode ) . ' ' . esc_attr( $field_class ) . '" autocomplete="off" />';
    ...
    function ot_type_upload_id( $args = array() ) {
        ...
        echo '<div class="ut-ui-upload-parent ' . esc_attr( $field_class ) . '">';
            ...
            if ( !empty( $field_value ) ) {
                ...
                echo '<button class="ut-ui-remove-media ut-ui-remove-media-id ut-ui-button" title="' . __( 'X', 'option-tree' ) . '">' . __( 'X', 'option-tree' ) . '</button>';
            ...
            /* add media button */
            echo '<button class="ut-media-upload ut-media-upload-id ut-ui-button ut-single-media-upload" rel="' . $post_id . '" title="' . __( 'Add Media', 'option-tree' ) . '">' . __( 'Add Media', 'option-tree' ) . '</button>';
