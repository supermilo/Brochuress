    ...
    class UT_Blog_CSS extends UT_Custom_CSS { 
        ...
        public function custom_css() {
            ...
            <?php if( ot_get_option("ut_blog_overview_date_background_color") ) : ?>
                ...
                .ut-blog-grid-article .date-format,
                .ut-blog-list-article .date-format {
            ...
            <?php if( ot_get_option("ut_global_post_tags_hash_color") ) : ?>
                ...
                .tags-links .fa-hashtag {
                    color: <?php echo ot_get_option("ut_global_post_tags_hash_color"); ?>;
                }
            ...
            <?php if( ot_get_option("ut_global_post_tags_color") ) : ?>
                ...
                .tags-links a {
                    color: <?php echo ot_get_option("ut_global_post_tags_color"); ?>;
                }
            ...
            <?php if( ot_get_option("ut_global_post_tags_color_hover") ) : ?>
                ...
                .tags-links a:hover,
                .tags-links a:active {
                    color: <?php echo ot_get_option("ut_global_post_tags_color_hover"); ?>;
                }
