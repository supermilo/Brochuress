...
if ( !function_exists( 'ut_get_morphbox_meta' ) ) {

    function ut_get_morphbox_meta( $image_id ) {
        ...
        if( ot_get_option( 'ut_lightgallery_type', 'lightgallery' ) == 'lightgallery' ) {
            ...
            $meta['data-title']   = isset( $attachment_meta->post_title ) ? esc_attr( $attachment_meta->post_title ) : '';
            $meta['data-caption'] = isset( $attachment_meta->post_title ) ? esc_attr( $attachment_meta->post_excerpt ) : '';
