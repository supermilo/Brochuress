    ...
    function _ut_recognized_plugins() {
        ...
        return array(
            ...
            array(
				...
				'slug'     				=> 'ut-twitter',
				'source'   				=> $bucket . 'ut-twitter-3.1.2.zip',
				'required' 				=> true, 
				'version' 				=> '3.1.2',
			...
			array(
				...
				'slug'     				=> 'ut-shortcodes',
				'source'   				=> $bucket . 'ut-shortcodes-4.7.7.zip',
				'required' 				=> true, 
				'version' 				=> '4.7.6',
			...
			array(
				...
				'slug'     				=> 'ut-portfolio',
				'source'   				=> $bucket . 'ut-portfolio-4.5.zip',
				'required' 				=> true, 
				'version' 				=> '4.5',
			...
			array(
				...
				'slug'     				=> 'ut-pricing',
				'source'   				=> $bucket . 'ut-pricing-3.2.zip',
				'required' 				=> true, 
				'version' 				=> '3.2',
            ...
            array(
				...
				'slug'     				=> 'js_composer',
				'source'   				=> $bucket . 'js_composer-5.8.zip',
				'required' 				=> true, 
				'version' 				=> '5.8',
			...
			array(
				...
				'slug'     				=> 'revslider',
				'source'   				=> $bucket . 'revslider-6.1.5.zip',
				'version' 				=> '6.1.5',
