...
class UT_Theme_Info {
    ...
    function dashboard_notification() {
        ...
        if( $this->daboard_notification && !get_option('hide_unite_health_dashboard_notification') ) {
            ...
            $message = esc_html__( 'Attention: Please check "Server Health" admin page first and make sure no values are marked yellow or red! This will guarantee that theme and plugins will work with best performance.', 'unite-admin' );
            $link = '<a href="' . get_admin_url() . 'admin.php?page=unite-theme-info">' . esc_html__( 'View Server Health Status', 'unite-admin' ) . '</a>';
